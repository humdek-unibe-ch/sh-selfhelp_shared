...
export const PERMISSIONS = {
    ...
    ADMIN_CMS_APP_READ: 'admin.cms_app.read',
    ADMIN_CMS_APP_CREATE: 'admin.cms_app.create',
    ADMIN_CMS_APP_UPDATE: 'admin.cms_app.update',
    ADMIN_CMS_APP_DELETE: 'admin.cms_app.delete',
